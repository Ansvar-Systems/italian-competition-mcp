...
const TOOLS = [
  {
    ...
    inputSchema: {
      ...
      properties: {
        query: { type: "string", description: "Search query (e.g., 'intesa anticoncorrenziale', 'abuso di posizione dominante', 'concentrazione')" },
        type: {
          type: "string",
  ...
  },
  {
    ...
    inputSchema: {
      type: "object" as const,
      properties: {
        case_number: { type: "string", description: "AGCM case number (e.g., 'A555', 'C12345')" },
      },
  ...
  },
  {
    ...
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query (e.g., 'Mediaset', 'Enel')" },
        sector: { type: "string", description: "Filter by sector ID. Optional." },
        outcome: {
          type: "string",
  ...
  },
  {
    ...
    inputSchema: {
      type: "object" as const,
      properties: {
        case_number: { type: "string", description: "AGCM merger case number (e.g., 'C12345')" },
      },
      required: ["case_number"],
    },
  },
  {
    ...
    description:
      "List all sectors with AGCM enforcement activity, including decision and merger counts.",
      ...
      switch (name) {
        ...
        case "it_comp_about": {
          return textContent({
            ...
            version: pkgVersion,
            description:
              "AGCM (Autorita Garante della Concorrenza e del Mercato) MCP server. Provides access to Italian competition law enforcement decisions and merger control cases.",
